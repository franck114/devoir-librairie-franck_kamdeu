...
<head>
    ...
    <title>Favoris || LIBRAIRIE LA PLUME</title>
</head>
...
<body>
        ...
        <div class="entete">
            ...
            <div class="lien">
                <ul>
                    ...
                    <li><a href="#"><i class="fas fa-heart"></i> <span id="favoris">0</span></a></li>
    ...
    <main>
        <div class="liv">
            ...
            <p>
                voici les livres que vous avez mis en favoris 
            </p>
        </div>
        <table>
            <thead>
            ...
            <tbody id="favoris-list">
                <!-- les livres mis en favoris seront afficher ici -->
            </tbody>
        </table>
